const { extend, uniqueId, random } = require("lodash")
      ...
      switch (type) {
        ...
        case "artwork":
          return {
            ...
            edition_sets: [fabricate("edition_set")],
            flags: [fabricate("flag")],
        ...
        case "artwork_image":
          return {
            ...
            image_url:
              "/local/additional_images/4e7cb83e1c80dd00010038e2/1/:version.jpg",
            image_versions: [
              "small",
              "square",
              "medium",
            ...
            original_width: 1000,
            tile_base_url:
              "/local/additional_images/4e7cb83e1c80dd00010038e2/1/dztiles-512-0",
            tile_format: "jpg",
            tile_overlap: 0,
            tile_size: 512,
          }

        case "show_install_shot":
          return {
            id: `525cb7488b3b810e050001af${uniqueId()}`,
            position: 2282,
            default: false,
            aspect_ratio: 1.33,
            ...
            image_url:
              "http://static1.artsy.net/partner_show_images/525cb7488b3b810e050001af/1/:version.jpg",
          }

        case "edition_set":
          return {
            id: "34f4wawe" + uniqueId(),
        ...
        case "featured_link":
          return {
            ...
            subtitle:
              "If you are interested in cats, and specifically the best cat in the world, you've come to the right place",
        ...
        case "user":
          return {
            id: "54276766fd4f50996aeca2" + random(10, 99),
            name: "Craig Spaeth",
            website: null,
        ...
        case "profile":
          return {
            icon: {
              ...
              image_url:
                "http://static0.artsy.net/profile_icons/504e3beab19ddf0002000534/:version.jpg",
            ...
            private: false,
            bio:
              "Living the dream as Content Partner Manager @Artsy. In a serious relationship with: dance floors, breakfast burritos, and historical biographies.",
        ...
        case "offer":
          return {
            id: "offer_id" + uniqueId(),
            artwork: fabricate("artwork"),
            user: fabricate("user"),
            description:
              "Aute terry richardson ullamco, bicycle rights aliquip aesthetic.",
            hide_price: true,
            partner_name: null,
        ...
        case "artwork_inquiry_request":
          return {
            ...
            phone: "555-555-5555",
            user: fabricate("user"),
            statuses: [fabricate("status"), fabricate("status")],
            flags: [fabricate("flag")],
          }
        ...
        case "film":
          return {
            ...
            default_video_still_id: uniqueId(),
            artist: defaultExport("artist"),
            artworks: [defaultExport("artwork")],
        ...
        case "video_still":
          return {
            ...
            image_url:
              "/local/video_stills/4f7e6a3b4b2a4f544100022f/:version.jpg",
          }
        ...
        case "show":
          return {
            ...
            id: "gagosian-gallery-inez-and-vinoodh" + uniqueId(),
            partner: fabricate("partner"),
            fair: null,
        ...
        case "gene":
          return {
            ...
            image_url:
              "http://static0.artsy.net/genes/4e5e41670d2c670001030350/:version.jpg",
            image_versions: ["thumb", "square", "tall", "big_and_tall"],
            counts: {
              artworks: 1611,
              artists: 80,
            },
        ...
        case "gene_type":
          return {
            id: "art-historical-influences" + uniqueId(),
        ...
        case "order_line_item":
          return {
            ...
            subtotal: "$1,800.00",
            artwork: fabricate("artwork"),
            edition_set: fabricate("edition_set", {
              acquireable: true,
              sold: false,
              forsale: true,
              price: "$1,800",
        ...
        case "featured_partners_profiles":
          return [
            fabricate(
              "partner_profile",
              fabricate(
                ...
                fabricate(
                  ...
                  fabricate(
                    "partner_profile",
                    fabricate("partner_profile", fabricate("partner_profile"))
                  )
                )
              )
            ),
        ...
        case "delayed_job":
          return {
            ...
            locked_by: null,
            name:
              "Artwork[50c932a7b7902c88ea000d01].additional_images.find()#recreate_image_versions!",
            priority: 3,
        ...
        case "mail_template":
          return {
            ...
            content: "foobuu",
            id:
              "artworkinquiryrequestmailer-artwork-inquiry-batch-confirmation-email",
        ...
        case "weekly_email_new":
          return {
            subject: "",
            html: "",
          }

        case "weekly_email_section":
          return { _type: "" }

        case "weekly_email_section_artworks":
          return {
            id: uniqueId(),
        ...
        case "gene_automation_rule":
          return {
            acts_on: "artwork",
            created_at: "2012-08-24T15:39:51Z",
            description:
              "Career Stage Gene is ` in the Artist genome, and is simply propagated to all of the artist's artworks!",
            id: uniqueId(),
        ...
        case "post":
          return {
            ...
            attachments: [],
            body:
              "<p>Check out the original flowers photograph taken by Patricia Caulfield which Warhol stole to make his painting.</p>",
            content_links: [],
            created_at: "2013-06-27T03:25:00Z",
            default_image_url:
              "http://static2.artsy.net/post_images/51cbb219f61af55db8000061/large.jpg",
            featured: true,
            id:
              "billpowers-check-out-the-original-flowers-photograph-taken-by-patricia",
            ...
            reposts_count: 0,
            summary:
              " Check out the original flowers photograph taken by Patricia Caulfield which Warhol stole to make his painting. ",
            title: "",
        ...
        case "auction_result":
          return {
            ...
            external_url:
              "http://www.lempertz-online.de/gldet_gb.asp?v=k1026400009980073900011&mkat=0&mablos=737&msb=&martist=0",
            id: uniqueId(),
            image_url:
              "http://static1.artsy.net/auction_lots/51d041844c91c616610005a0/thumbnail.jpg",
        ...
        case "artist_filtered_search_suggest":
          return {
            total: 79,
            related_gene: {},
            medium: {
        ...
        case "article":
          return {
            ...
            fair_id: null,
            featured: true,
            featured_artist_ids: ["4d9b330cff9a375c2f0031a8"],
            ...
            partner_ids: ["4d8b92c44eb68a1b2c0004cb"],
            published: true,
            ...
            sections: [
                ...
                artworks: [
                  {
                    ...
                    title: "Poppies",
                    image:
                      "https://d32dm0rphc51dk.cloudfront.net/drYmDIGBNsc49rrtiLzlbw/larger.jpg",
                    partner: {
                      name: "Pace",
                      slug: "pace",
                    },
              ...
              },
              {
                type: "text",
                body:
                  '<p>This wave of Asian shows comes on the heels of a vibrant spring season. In New York, three of Ruby’s giant ceramic dishes were featured in the&nbsp;<a href="https://artsy.net/feature/whitney-biennial-2014">Whitney Biennial</a>, while his fluency in various mediums was on view in a giant solo show at Hauser &amp; Wirth, and, in June, Ruby sent an expansive installation of soft sculptures to&nbsp;<a href="https://artsy.net/art-basel">Art Basel</a>&nbsp;for its Unlimited sector. This fall is no different: his works have surfaced in major shows in L.A. and New York (in LACMA’s “Variations: Conversations In and Around Abstract Painting” and Venus Over Manhattan’s “FIRE!” curated by&nbsp;<a href="https://artsy.net/simondepury">Simon de Pury</a>); however, more extensive presentations of his works can be found in Hong Kong, Beijing, Tokyo, Taipei, and Gwangju—take your pick.</p>',
              },
              {
                type: "image",
                url:
                  "https://artsy-media-uploads.s3.amazonaws.com/a2jvzxBrRFG_Bk-tss1kWw%2FInstallation_shot_Sterling_Ruby_%282%29.JPG",
                caption:
                  "<p>Installation view of&nbsp;“The Los Angeles Project” at Ullens Center for Contemporary Art, Beijing. Courtesy UCCA</p>",
              },
              {
                type: "image",
                url:
                  "https://artsy-media-uploads.s3.amazonaws.com/7v_VrQo5ydLiE0mMLG8FAA%2FInstallation_shot_Sterling_Ruby.JPG",
                caption:
                  "<p>Installation view of&nbsp;“The Los Angeles Project” at Ullens Center for Contemporary Art, Beijing. Courtesy UCCA</p>",
              },
              {
              ...
              {
                type: "artworks",
                ids: ["541c4d3f7261692d84ba0000", "541c4d3f72616929e50e0600"],
                layout: "overflow_fillwidth",
                artworks: [
                  {
                    type: "artwork",
